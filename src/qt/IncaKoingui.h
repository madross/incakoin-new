#ifndef INCAKOINGUI_H
#define INCAKOINGUI_H
...
*/
class IncaKoinGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit IncaKoinGUI(QWidget *parent = 0);
    ~IncaKoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a IncaKoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */

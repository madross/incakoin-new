...
#ifndef _INCAKOINRPC_H_
#define _INCAKOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // IncaKoin is not connected
...
/**
 * IncaKoin RPC command dispatcher.
 */
class CRPCTable
{
private:
